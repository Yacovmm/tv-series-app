...
//import com.medcelareadoalunov4.features.recyclerview.cell.SectionCell
...
//        fun cellForPosition(sectionAdapter:GenericSectionAdapter<*>, cell:RecyclerView.ViewHolder, position:Int)
...
//        fun cellHeaderType(sectionAdapter:GenericSectionAdapter<*>, view: View): BaseCell {return SectionCell(view)}
//        fun didSelectItemAt(sectionAdapter:GenericSectionAdapter<*>, index:Int) {}
//        fun numberOfRows(sectionAdapter:GenericSectionAdapter<*>):Int? { return null}
//    }
//
...
//            .headerResourceId(R.layout.recyclerview_cell_section)
...
//    }
//
//    constructor(resId:Int, list: MutableList<T>) : super(SectionParameters.builder()
//        .itemResourceId(resId)
//        .emptyViewWillBeProvided()
//        .build()) {
//
